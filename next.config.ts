...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "connect-src 'self' https://api.paystack.co https://*.supabase.co wss://*.supabase.co https://unpkg.com https://cloudflareinsights.com https://heyzine.com https://*.heyzine.com",
      "frame-src 'self' https://js.paystack.co https://*.supabase.co https://heyzine.com https://*.heyzine.com https://aflip.in https://*.aflip.in",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
