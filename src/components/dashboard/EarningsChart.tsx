  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
        ...
        <XAxis dataKey="month" stroke="#888888" fontSize={12} tickLine={false} axisLine={false} tickFormatter={(val) => val} />
        ...
        <Tooltip 
          ...
          formatter={(value) => [`GHS ${typeof value === 'number' ? value.toFixed(2) : 0}`, "Earnings"]}
        />
