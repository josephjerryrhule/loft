    ...
    <TooltipProvider>
      <div className="space-y-8 animate-in fade-in duration-500 pb-10">
        <PageHeader
            ...
            actions={
                <div className="flex items-center gap-3 px-5 h-12 bg-slate-50 dark:bg-slate-800 rounded-2xl shadow-inner">
      ...
      {orders.length === 0 ? (
        <div className="flex justify-center pt-10">
            <Card className="max-w-md border-none shadow-2xl overflow-hidden bg-white dark:bg-slate-900 rounded-[2.5rem]">
                <div className="bg-slate-50 dark:bg-slate-800/50 p-12 flex flex-col items-center justify-center text-center">
                    <div className="h-20 w-20 rounded-full bg-white dark:bg-slate-900 flex items-center justify-center shadow-lg mb-6">
        ...
        <div className="rounded-[2rem] border-none shadow-xl overflow-hidden bg-white dark:bg-slate-900 animate-in slide-in-from-bottom-4 duration-500">
