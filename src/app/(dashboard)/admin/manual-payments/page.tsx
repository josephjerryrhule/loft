...
export default function AdminManualPaymentsPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <PageHeader
        title="Manual Payments (Admin)"
        subtitle="Track manual payments, competition prizes, bonuses, and commission allocations across the system"
        actions={
          <Link href="/admin/manual-payments/new">
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="px-6 py-4 text-right">
                          <Link href={`/admin/manual-payments/${payment.id}`}>
