  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {compact ? (
          <Button variant="ghost" size="icon" className="h-6 w-6 rounded-full text-slate-500 hover:text-slate-800 hover:bg-slate-100 p-0 cursor-pointer animate-in fade-in duration-200" title="Reassign Session">
