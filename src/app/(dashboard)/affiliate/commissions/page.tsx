...
export default function AffiliateCommissionsPage() {
    ...
    async function loadCommissions(page: number) {
        setLoading(true);
        try {
            const data = await getAffiliateCommissions(page, pageSize);
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
                 ...
                 <div className="border rounded-md p-4 bg-card">
                    ...
                    <div className="text-2xl font-bold mt-2">{currencySymbol} {stats?.monthEarnings.toFixed(2)}</div>
                 </div>
            </div>
                        ...
                        {commissions.length === 0 ? (
                            ...
                            commissions.map((comm) => (
                                <TableRow key={comm.id}>
                                     ...
                                     <TableCell>{currencySymbol} {comm.amount.toFixed(2)}</TableCell>
                                     <TableCell>
                                        <Badge variant={
