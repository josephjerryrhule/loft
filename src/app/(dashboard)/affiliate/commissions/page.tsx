...
import { Loader2, DollarSign, Wallet, Clock, TrendingUp, Search, Calendar, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-10">
             <PageHeader 
                ...
                subtitle="Track your network earnings and manage weekly payouts"
             />
